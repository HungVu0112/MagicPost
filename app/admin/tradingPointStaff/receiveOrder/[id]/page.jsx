...
export default function Order () {
    ...
    const handleClick = async () => {
        const res = await fetch(`/api/order/setShippingToCustomer/${order.orderID}`, {
            method: 'GET'
        })
    ...
    return (
        <>
                    ...
                    <div className="flex mt-3">
                        ...
                        <div className="w-[50%] border-2 border-black border-l-0">
                            ...
                            <div className="flex h-[80%]">
                                ...
                                <div className="w-[40%] h-full border-t-2 border-black">
                                    <div className="p-2">
            ...
            {success && <Toast type="success" message="Xác nhận đơn giao !" setAppear={setSuccess} />}
        </>
        )
}